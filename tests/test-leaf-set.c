...
START_TEST(test_leaf_set_02)
{
    ...
    verify_leaf_set(set,
        "[- 2] 00000000000000000000000000000065 local:3\n"
        "[- 1] 00000000000000000000000000000063 local:2\n"
        "[  0] 00000000000000000000000000000064 local:1\n"
        "[+ 1] 00000000000000000000000000000065 local:3\n"
        "[+ 2] 00000000000000000000000000000063 local:2\n"
    );
    crs_leaf_set_free(set);
    crs_ctx_free(ctx);
    fail_if_error(crs_finalize_tests());
...
START_TEST(test_leaf_set_03)
{
    ...
    add_to_set(ctx, set, 101);
    verify_leaf_set(set,
        "[-12] 00000000000000000000000000000065 local:13\n"
        "[-11] 00000000000000000000000000000066 local:12\n"
        "[-10] 00000000000000000000000000000067 local:11\n"
        "[- 9] 00000000000000000000000000000068 local:10\n"
        "[- 8] 00000000000000000000000000000069 local:9\n"
        "[- 7] 0000000000000000000000000000006a local:8\n"
        ...
        "[+ 7] 0000000000000000000000000000005e local:2\n"
        "[+ 8] 0000000000000000000000000000005f local:3\n"
        "[+ 9] 00000000000000000000000000000060 local:4\n"
        "[+10] 00000000000000000000000000000061 local:5\n"
        "[+11] 00000000000000000000000000000062 local:6\n"
        "[+12] 00000000000000000000000000000063 local:7\n"
    );
    crs_leaf_set_free(set);
    crs_ctx_free(ctx);
    fail_if_error(crs_finalize_tests());
